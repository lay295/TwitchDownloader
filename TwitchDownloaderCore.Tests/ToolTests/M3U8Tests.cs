...
public class M3U8Tests {
    ...
    public void CorrectlyParsesTwitchM3U8OfTransportStreams(bool useStream, string culture) {
        ...
        Assert.Equal(
            "2023-09-23T17:37:06",
            m3u8.FileMetadata.UnparsedValues.FirstOrDefault(x => x.Key == "#ID3-EQUIV-TDTG:").Value
        );
    ...
    public void CorrectlyParsesTwitchM3U8OfLiveStreams(bool useStream, string culture) {
        ...
        var streamValues = new (DateTimeOffset programDateTime, decimal duration, bool isLive, string path)[] {
            (DateTimeOffset.Parse("2023-09-17T02:31:48.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/abc-123DEF_456.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:31:50.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/ghi-789JKL_012.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:31:52.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/mno-345PQR_678.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:31:54.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/stu-901VWX_234.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:31:56.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/yza-567BCD_890.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:31:58.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/efg-123hij_456.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:00.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/klm-789nop_012.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:02.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/qrs-345TUV_678.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:04.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/wxy-901ZAB_234.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:06.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/cde-567FGH_890.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:08.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/ijk-123lmn_456.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:10.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/opq-789RST_012.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:12.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/uvx-345YZA_678.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:14.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/bcd-901EFG_234.ts"),
            (DateTimeOffset.Parse("2023-09-17T02:32:16.242Z"), 2.000m, true,
                "https://video-edge-foo.bar.abs.hls.ttvnw.net/v1/segment/hij-567KLM_890.ts")
        };
    ...
    public void CorrectlyParsesTwitchM3U8OfPlaylists(bool useStream, string culture) {
        ...
        var streams = new M3U8.Stream[] {
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "chunked", "1080p60", false, false),
                new(0, 5898203, "avc1.64002A,mp4a.40.2", (1920, 1080), "chunked", 59.995m),
                "https://abc123def456gh.cloudfront.net/123abc456def789ghi01_streamer42_12345678901_1234567890/chunked/index-dvr.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "720p60", "720p60", true, true),
                new(0, 3443956, "avc1.4D0020,mp4a.40.2", (1280, 720), "720p60", 59.995m),
                "https://abc123def456gh.cloudfront.net/123abc456def789ghi01_streamer42_12345678901_1234567890/720p60/index-dvr.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "480p30", "480p", true, true),
                new(0, 1454397, "avc1.4D001F,mp4a.40.2", (852, 480), "480p30", 29.998m),
                "https://abc123def456gh.cloudfront.net/123abc456def789ghi01_streamer42_12345678901_1234567890/480p30/index-dvr.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "audio_only", "Audio Only", false, false),
                new(0, 220328, "mp4a.40.2", (0, 0), "audio_only", 0m),
                "https://abc123def456gh.cloudfront.net/123abc456def789ghi01_streamer42_12345678901_1234567890/audio_only/index-dvr.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "360p30", "360p", true, true),
                new(0, 708016, "avc1.4D001E,mp4a.40.2", (640, 360), "360p30", 29.998m),
                "https://abc123def456gh.cloudfront.net/123abc456def789ghi01_streamer42_12345678901_1234567890/360p30/index-dvr.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "160p30", "160p", true, true),
                new(0, 288409, "avc1.4D000C,mp4a.40.2", (284, 160), "160p30", 29.998m),
                "https://abc123def456gh.cloudfront.net/123abc456def789ghi01_streamer42_12345678901_1234567890/160p30/index-dvr.m3u8"
            )
        };
    ...
    public void CorrectlyParsesTwitchM3U8MediaInfo(
        string mediaInfoString,
        M3U8.Stream.ExtMediaInfo.MediaType type,
        string groupId,
        string name,
        bool autoSelect,
        bool @default
    ...
    [InlineData(
        "#EXT-X-STREAM-INF:BANDWIDTH=288409,CODECS=\"avc1.4D000C,mp4a.40.2\",RESOLUTION=284x160,VIDEO=\"160p30\",FRAME-RATE=29.998",
        288409,
        "avc1.4D000C,mp4a.40.2",
        284,
        160,
        "160p30",
        29.998
    )]
    public void CorrectlyParsesTwitchM3U8StreamInfo(
        string streamInfoString,
        int bandwidth,
        string codecs,
        uint videoWidth,
        uint videoHeight,
    ...
    public void CorrectlyParsesKickM3U8OfPlaylists(bool useStream, string culture) {
        ...
        var streams = new M3U8.Stream[] {
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "1080p60", "1080p60", true, true),
                new(1, 9878400, "avc1.64002A,mp4a.40.2", (1920, 1080), "1080p60", 60m),
                "1080p60/playlist.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "720p60", "720p60", true, true),
                new(1, 3330599, "avc1.4D401F,mp4a.40.2", (1280, 720), "720p60", 60m),
                "720p60/playlist.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "480p30", "480p", true, true),
                new(1, 1335600, "avc1.4D401F,mp4a.40.2", (852, 480), "480p30", 30m),
                "480p30/playlist.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "360p30", "360p", true, true),
                new(1, 630000, "avc1.4D401F,mp4a.40.2", (640, 360), "360p30", 30m),
                "360p30/playlist.m3u8"
            ),
            new(
                new(M3U8.Stream.ExtMediaInfo.MediaType.Video, "160p30", "160p", true, true),
                new(1, 230000, "avc1.4D401F,mp4a.40.2", (284, 160), "160p30", 30m),
                "160p30/playlist.m3u8"
            )
        };
    ...
    public void CorrectlyParsesKickM3U8MediaInfo(
        string mediaInfoString,
        M3U8.Stream.ExtMediaInfo.MediaType type,
        string groupId,
        string name,
    ...
    public void CorrectlyParsesKickM3U8StreamInfo(
        string streamInfoString,
        int bandwidth,
        string codecs,
        uint videoWidth,
