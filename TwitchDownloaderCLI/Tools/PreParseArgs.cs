...
internal static class PreParseArgs {
    ...
    /// <summary>
    ///     Converts an argument <see cref="string" />[] using any legacy syntax to the current syntax and prints corresponding
    ///     warning messages
    /// </summary>
    ...
    private static string[] ConvertFromOldSyntax(string[] args, string processFileName) {
        ...
        for (var i = 0; i < processedArgs.Count; i++)
            switch (processedArgs[i]) {
                case "--embed-emotes":
                    Console.WriteLine(
                        "[INFO] The program has switched from --embed-emotes to -E / --embed-images, consider using those instead. Run \'{0} help\' for more information.",
                        processFileName
                    );
                ...
                case "-m" or "--mode":
                    Console.WriteLine(
                        "[INFO] The program has switched from --mode <mode> to verbs (like \'git <verb>\'), consider using verbs instead. Run \'{0} help\' for more information.",
                        processFileName
                    );
                ...
                case "--silent":
                    Console.WriteLine(
                        "[INFO] The program has switched from --silent to log levels, consider using log levels instead. '--log-level None' will be applied to the current session. Run \'{0} help\' for more information.",
                        processFileName
                    );
                ...
                case "--verbose-ffmpeg":
                    Console.WriteLine(
                        "[INFO] The program has switched from --verbose-ffmpeg to log levels, consider using log levels instead. '--log-level Status,Info,Warning,Error,Ffmpeg' will be applied to the current session. Run \'{0} help\' for more information.",
                        processFileName
                    );
                ...
                case "--chat-connections":
                    Console.WriteLine(
                        "[INFO] The program has switched from --chat-connections to -t / --threads, consider using those instead. Run \'{0} help\' for more information.",
                        processFileName
                    );
    ...
    private static void ConvertEmbedEmoteSyntax(IList<string> args, int index) { args[index] = "-E"; }
    ...
    private static void ConvertChatConnectionsSyntax(IList<string> args, int index) { args[index] = "--threads"; }
}
