...
namespace TwitchDownloaderCLI
{
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            var parserResult = parser.ParseArguments<VideoDownloadArgs, ClipDownloadArgs, ChatDownloadArgs, ChatUpdateArgs, ChatRenderArgs, StreamInfoArgs, FfmpegArgs, CacheArgs, TsMergeArgs>(preParsedArgs);
