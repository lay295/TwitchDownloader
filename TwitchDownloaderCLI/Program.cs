...
namespace TwitchDownloaderCLI
{
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            var parserResult = parser.ParseArguments<VideoDownloadArgs, ClipDownloadArgs, ChatDownloadArgs, ChatUpdateArgs, ChatRenderArgs, ChatRecorderArgs, InfoArgs, FfmpegArgs, CacheArgs, UpdateArgs, TsMergeArgs>(preParsedArgs);
            ...
            parserResult
                ...
                .WithParsed<ChatRecorderArgs>(RecordChat.Record)
