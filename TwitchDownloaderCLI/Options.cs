...
namespace TwitchDownloaderCLI
{
    ...
    class Options
    {
        ...
        [Option("bttv", Default = false, HelpText = "Enable BTTV emotes in chat download/render.")]
        public bool BttvEmotes { get; set; }
        [Option("ffz", Default = false, HelpText = "Enable FFZ emotes in chat download/render.")]
        public bool FfzEmotes { get; set; }
        [Option("stv", Default = false, HelpText = "Enable 7tv emotes in chat download/render.")]
