...
namespace TwitchDownloaderCLI.Modes.Arguments
{
    ...
    public class ChatRenderArgs
    {
        ...
        [Option("comment-dispersion", Default = true, HelpText = "In November 2022 a Twitch API change made chat messages download only in whole seconds. If there are multiple messages on a second, they will be intelligently distributed over the second to improve chat flow.")]
