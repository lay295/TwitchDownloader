...
internal sealed class ChatRenderArgs : IFileCollisionArgs, ITwitchDownloaderArgs {
    ...
    [Option(
        "background-color",
        Default = "#111111",
        HelpText = "The render background color in the string format of '#RRGGBB' or '#AARRGGBB' in hexadecimal."
    )]
    ...
    [Option(
        ...
        Default = "#191919",
        HelpText
            = "The alternate message background color in the string format of '#RRGGBB' or '#AARRGGBB' in hexadecimal. Requires --alternate-backgrounds"
    )]
    ...
    [Option(
        "message-color",
        Default = "#ffffff",
        HelpText = "The message text color in the string format of '#RRGGBB' or '#AARRGGBB' in hexadecimal."
    )]
    ...
    [Option(
        ...
        "beginning",
        HelpText
            = "Time to trim the beginning of the render. Can be milliseconds (#ms), seconds (#s), minutes (#m), hours (#h), or time (##:##:##)."
    )]
    ...
    [Option(
        ...
        "ending",
        HelpText
            = "Time to trim the ending of the render. Can be milliseconds (#ms), seconds (#s), minutes (#m), hours (#h), or time (##:##:##)."
    )]
    ...
    [Option(
        "message-fontstyle",
        Default = "normal",
        HelpText = "Font style of messages. Valid values are normal, bold, and italic."
    )]
    ...
    [Option(
        "username-fontstyle",
        Default = "bold",
        HelpText = "Font style of usernames. Valid values are normal, bold, and italic."
    )]
    ...
    [Option(
        "timestamp",
        Default = false,
        HelpText = "Enable timestamps to the left of messages, similar to VOD chat on Twitch."
    )]
    ...
    [Option(
        "generate-mask",
        Default = false,
        HelpText = "Generates a mask file of the chat in addition to the rendered chat."
    )]
    ...
    [Option(
        "sharpening",
        Default = false,
        HelpText = "Appends a smartblur sharpening filter to the input-args. Works best with font-size 24 or larger."
    )]
    ...
    [Option(
        ...
        HelpText = "Input arguments for FFmpeg chat render."
    )]
    public string InputArgs { get; set; }

    [Option(
        "output-args",
        Default = "-c:v libx264 -preset veryfast -crf 18 -pix_fmt yuv420p \"{save_path}\"",
        HelpText = "Output arguments for FFmpeg chat render."
    )]
    ...
    [Option(
        "ignore-users",
        Default = "",
        HelpText = "List of usernames to ignore when rendering, separated by commas. Not case-sensitive."
    )]
    ...
    [Option(
        "ban-words",
        Default = "",
        HelpText = "List of words or phrases to ignore when rendering, separated by commas. Not case-sensitive."
    )]
    ...
    [Option(
        ...
        Default = 0,
        HelpText
            = "Bitmask of types of Chat Badges to filter out. Add the numbers of the types of badges you want to filter. For example, 6 = no broadcaster or moderator badges.\r\nKey: Other = 1, Broadcaster = 2, Moderator = 4, VIP = 8, Subscriber = 16, Predictions = 32, NoAudio/NoVideo = 64, PrimeGaming = 128"
    )]
    ...
    [Option(
        ...
        Default = false,
        HelpText
            = "In November 2022 a Twitch API change made chat messages download only in whole seconds. This option uses additional metadata to attempt to restore messages to when they were actually sent. This may result in a different comment order. Requires an update rate less than 1.0 for effective results."
    )]
    ...
    [Option(
        ...
        Default = false,
        HelpText = "Alternates the background color of every other chat message to help tell them apart."
    )]
    ...
    [Option(
        "readable-colors",
        Default = false,
        HelpText = "Increases the contrast of usernames against the background or outline color."
    )]
    ...
    [Option(
        "offline",
        Default = false,
        HelpText = "Render completely offline using only embedded emotes, badges, and bits from the input json."
    )]
    ...
    [Option(
        ...
        Default = "notocolor",
        HelpText
            = "The emoji vendor used for rendering emojis. Valid values are: 'twitter' / 'twemoji', 'google' / 'notocolor', and 'system' / 'none'."
    )]
    ...
    [Option(
        ...
        Default = false,
        HelpText
            = "Do not wait for the output drive to transmit a ready signal before writing the next frame. Waiting is usually only necessary on low-end USB drives."
    )]
    ...
    [Option(
        ...
        Default = 1.0,
        HelpText = "Number to scale highlight stroke size (sub messages)."
    )]
    ...
    [Option(
        ...
        Default = 1.0,
        HelpText = "Number to scale highlight indent size (sub messages)."
    )]
