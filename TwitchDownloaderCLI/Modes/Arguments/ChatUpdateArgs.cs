...
internal sealed class ChatUpdateArgs : IFileCollisionArgs, ITwitchDownloaderArgs {
    ...
    [Option(
        "compression",
        Default = ChatCompression.None,
        HelpText
            = "Compresses an output json chat file using a specified compression, usually resulting in 40-90% size reductions. Valid values are: None, Gzip."
    )]
    ...
    [Option(
        ...
        "embed-missing",
        Default = false,
        HelpText = "Embeds missing emotes, badges, and cheermotes. Already embedded images will be untouched."
    )]
    ...
    [Option(
        ...
        Default = false,
        HelpText
            = "Replace all embedded emotes, badges, and cheermotes in the file. All embedded images will be overwritten!"
    )]
    ...
    [Option(
        ...
        "beginning",
        HelpText
            = "New time for chat beginning. Can be milliseconds (#ms), seconds (#s), minutes (#m), hours (#h), or time (##:##:##). Comments may be added but not removed. -1 = Keep current trim."
    )]
    ...
    [Option(
        ...
        "ending",
        HelpText
            = "New time for chat ending. Can be milliseconds (#ms), seconds (#s), minutes (#m), hours (#h), or time (##:##:##). Comments may be added but not removed. -1 = Keep current trim."
    )]
    ...
    [Option(
        "timestamp-format",
        Default = TimestampFormat.Relative,
        HelpText = "Sets the timestamp format for .txt chat logs. Valid values are: Utc, Relative, and None"
    )]
