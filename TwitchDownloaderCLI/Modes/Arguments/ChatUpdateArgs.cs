...
namespace TwitchDownloaderCLI.Modes.Arguments
{
    ...
    internal sealed class ChatUpdateArgs : IFileCollisionArgs, ITwitchDownloaderArgs
    {
        ...
        [Option("giphy", Default = true, HelpText = "Enable Giphy GIF embedding in chat update. Urls are always recorded, images require -E / --embed-missing or -R / --replace-embeds!")]
