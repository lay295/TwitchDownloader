...
internal sealed class ChatDownloadArgs : IFileCollisionArgs, ITwitchDownloaderArgs {
    ...
    [Option(
        ...
        Required = true,
        HelpText
            = "Path to output file. File extension will be used to determine download type. Valid extensions are: .json, .html, and .txt."
    )]
    ...
    [Option(
        ...
        "beginning",
        HelpText
            = "Time to trim beginning. Can be milliseconds (#ms), seconds (#s), minutes (#m), hours (#h), or time (##:##:##)."
    )]
    ...
    [Option(
        ...
        "ending",
        HelpText
            = "Time to trim ending. Can be milliseconds (#ms), seconds (#s), minutes (#m), hours (#h), or time (##:##:##)."
    )]
    ...
    [Option(
        ...
        "embed-images",
        Default = false,
        HelpText = "Embed first party emotes, badges, and cheermotes into the chat download for offline rendering."
    )]
    ...
    [Option(
        ...
        HelpText = "Sets the timestamp format for .txt chat logs. Valid values are: Utc, UtcFull, Relative, and None"
    )]
    ...
    [Option(
        ...
        "threads",
        Default = 4,
        HelpText = "Number of parallel download threads. Large values may result in IP rate limiting."
    )]
