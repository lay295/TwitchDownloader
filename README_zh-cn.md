...
### [点击此处查看完整的 WPF 文档](TwitchDownloaderWPF/README_zh-cn.md)
...
通过社区翻译，Windows WPF GUI 有多种语言版本。见 [WPF 自述文件](TwitchDownloaderWPF/README_zh-cn.md)的[本地化](TwitchDownloaderWPF/README_zh-cn.md#本地化)部分。

### 主题

Windows WPF GUI 内置了浅色和深色主题，以及根据当前 Windows 主题进行实时更新的选项；它还支持用户创建主题！更多详情，见 [WPF 自述文件](TwitchDownloaderWPF/README_zh-cn.md)的[主题](TwitchDownloaderWPF/README_zh-cn.md#主题)部分。
...
聊天渲染可能会使用 [Noto Color Emoji](https://github.com/googlefonts/noto-emoji) © Google 及其贡献者
...
聊天 HTML 导出使用的 *Inter* 字体由 [Google Fonts API](https://fonts.google.com/) 托管 © Google

有关使用的外部库的完整列表见 [THIRD-PARTY-LICENSES.txt](./TwitchDownloaderCore/Resources/THIRD-PARTY-LICENSES.txt)
