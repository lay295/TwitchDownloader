...
namespace TwitchDownloaderCore.Extensions
{
    public static partial class M3U8Extensions
    {
        extension(M3U8 m3u8)
        {
            public void SortStreamsByQuality()
            {
            ...
            public M3U8 WithUnavailableMedia()
            {
        ...
        extension(M3U8.Stream stream)
        {
            ...
            /// </returns>
            public string GetResolutionFramerateString(bool appendSource = true)
            {
