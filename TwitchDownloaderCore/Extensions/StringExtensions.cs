...
namespace TwitchDownloaderCore.Extensions
{
    public static class StringExtensions
    {
        ...
        {
            public string ReplaceAny(SearchValues<char> oldChars, char newChar)
            {
            ...
            public string ReplaceNthOccurrence(char delimiter, Index index, ReadOnlySpan<char> newValue)
            {
                if (string.IsNullOrEmpty(str))
                {
                    return str;
