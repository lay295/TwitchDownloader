...
public static class SKPaintExtensions {
    private static readonly MethodInfo GetFontMethodInfo = typeof(SKPaint).GetMethod(
        "GetFont",
        BindingFlags.NonPublic | BindingFlags.Instance
    );

    private static readonly Func<SKPaint, SKFont> GetFontDelegate = (Func<SKPaint, SKFont>)Delegate.CreateDelegate(
        typeof(Func<SKPaint, SKFont>),
        SKPaintExtensions.GetFontMethodInfo
    );
    ...
    public static SKFont AsFont(this SKPaint paint) => SKPaintExtensions.GetFontDelegate.Invoke(paint);
