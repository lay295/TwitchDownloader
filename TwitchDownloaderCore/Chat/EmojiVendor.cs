...
public static class EmojiVendorExtensions {
    ...
    public static string EmojiFolder(this EmojiVendor vendor) {
        return vendor switch {
            ...
            _ => throw new NotSupportedException(EmojiVendorExtensions.NOT_SUPPORTED_MESSAGE)
        };
    }

    public static MemoryStream MemoryStream(this EmojiVendor vendor) {
        return vendor switch {
            EmojiVendor.TwitterTwemoji => new(Resources.twemoji_14_0_0),
            EmojiVendor.GoogleNotoColor => new(Resources.noto_emoji_2_038),
            _ => throw new NotSupportedException(EmojiVendorExtensions.NOT_SUPPORTED_MESSAGE)
        };
    }
