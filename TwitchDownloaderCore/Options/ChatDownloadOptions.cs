...
public class ChatDownloadOptions {
    ...
    public string FileExtension {
        get {
            return this.DownloadFormat switch {
                ChatFormat.Json when this.Compression is ChatCompression.None => "json",
                ChatFormat.Json when this.Compression is ChatCompression.Gzip => "json.gz",
