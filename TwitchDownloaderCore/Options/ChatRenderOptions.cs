...
public class ChatRenderOptions {
    ...
    public SKPaint AlternateBackgroundPaint => this._alternateBackgroundPaint
        ??= new() { Color = this.AlternateBackgroundColor, BlendMode = SKBlendMode.Src };
    ...
    public double ReferenceScale => this.FontSize / 24;
    public int SectionHeight => (int)(40 * this.ReferenceScale * this.SectionHeightScale);
    ...
    public int UpdateFrame {
        get {
            ...
            return (int)(this.UpdateRate * this.Framerate);
        }
    }
    ...
    public string MaskFile {
        get {
            if (this.OutputFile == "" || this.GenerateMask == false)
                return this.OutputFile;

            var extension = Path.GetExtension(this.OutputFile)!;
            var extensionIndex = this.OutputFile!.LastIndexOf(extension, StringComparison.Ordinal);
            return string.Concat(this.OutputFile.AsSpan(0, extensionIndex), "_mask", extension);
        }
    }
    ...
    public int SidePadding => (int)(6 * this.ReferenceScale * this.SidePaddingScale);
    public int VerticalPadding => (int)(24 * this.ReferenceScale * this.VerticalSpacingScale);
    public int WordSpacing => (int)(6 * this.ReferenceScale * this.WordSpacingScale);
    public int EmoteSpacing => (int)(6 * this.ReferenceScale * this.EmoteSpacingScale);
    public int AccentStrokeWidth => (int)(8 * this.ReferenceScale * this.AccentStrokeScale);
    public int AccentIndentWidth => (int)(32 * this.ReferenceScale * this.AccentIndentScale);
