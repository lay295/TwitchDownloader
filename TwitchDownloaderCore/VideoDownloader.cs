...
namespace TwitchDownloaderCore
{
    public sealed class VideoDownloader
    {
        ...
        /// <summary>
        /// Resolves the source-quality DVR playlist URL for a hidden VOD. If the broadcast's stream id
        /// and start time were not supplied on the options (e.g. captured earlier while live), they are
        /// fetched fresh from the channel's current stream. Throws if the channel is offline and no
        /// metadata was provided, or if no CDN is serving the reconstructed playlist.
        /// </summary>
