...
public class TwitchChatBadgeUser {
    [JsonPropertyName("broadcastBadges")] public List<TwitchChatBadge> badges { get; set; }
}
...
public class TwitchChatBadge {
    [JsonPropertyName("imageURL")] public string image_url_2x { get; set; }

    public string description { get; set; }
    public string title { get; set; }

    [JsonPropertyName("setID")] public string name { get; set; }
