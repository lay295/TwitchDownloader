                    ...
                    for (int i = 0; i < fragmentParts.Length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            if (Regex.Match(output, emojiRegex).Success)
                            {
                                ...
                                currentSection.hasEmote = true;
                                float emoteHeight = (float)(emojiBitmap.Height * renderOptions.image_scale);
                                g.DrawImage(emojiBitmap, drawPos.X + 2, (hasEmoteHeight - emoteHeight) / 2, (float)(emojiBitmap.Width * renderOptions.image_scale), emoteHeight);
