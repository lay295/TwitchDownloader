...
public static class AvailableCultures {
    ...
    public static readonly Culture[] All; // ReSharper disable StringLiteralTypo
    static AvailableCultures() {
        AvailableCultures.All = new[] {
            AvailableCultures.English = new("en-US", "English"),
            AvailableCultures.Spanish = new("es-ES", "Español"),
            AvailableCultures.French = new("fr-FR", "Français"),
            AvailableCultures.Italian = new("it-it", "Italiano"),
            AvailableCultures.Japanese = new("ja-JP", "日本語"),
            AvailableCultures.Polish = new("pl-PL", "Polski"),
            AvailableCultures.Polish = new("pt-BR", "Português (Brasil)"),
            AvailableCultures.Russian = new("ru-RU", "Русский"),
            AvailableCultures.Turkish = new("tr-TR", "Türkçe"),
            AvailableCultures.Ukrainian = new("uk-ua", "Українська"),
            AvailableCultures.SimplifiedChinese = new("zh-CN", "简体中文")
        };
    }
