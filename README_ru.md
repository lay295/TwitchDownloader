...
Корневой `TwitchDownloader.slnx` не включает Windows WPF, поэтому restore работает на Windows, Linux и macOS. Для WPF GUI на Windows откройте `TwitchDownloaderWPF/TwitchDownloaderWPF.slnx`.
